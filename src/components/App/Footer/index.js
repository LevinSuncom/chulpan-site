  ...
  render() {
    return (
      <div className="footer">
        ...
        {/* <Modal isOpen={this.state.sModalIsOpen} contentLabel="Modal">
          <div
            style={{
              display: 'flex',
              flexDirection: 'column',
            ...
            <form action="" className="callback mb-40">
              <label htmlFor="">Номер телефона</label>
              <input type="text" placeholder="Имя" className="mb-12" />
              <label htmlFor="">Тема</label>
              <textarea className="mb-12" placeholder="Текст обращения" />
              <label htmlFor="">Желательное время звонка</label>
              <input
                type="text"
                className="mb-32"
