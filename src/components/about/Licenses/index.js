  ...
  render() {
    return (
      <div>
        ...
        <strong>Акционерное общество Страховая компания "Чулпан"</strong>
        <br />
        ...
        <ul>
          <li>
            СЛ № 1216 от 07.05.2015г. (добровольное личное страхование, за
          ...
          <li>
            ОС № 1216-03 от 07.05.2015г. (обязательное страхование гражданской
            ответственности владельцев транспортных средств)
          </li>
          <li>
            ОС № 1216-04 от 07.05.2015г. (обязательное страхование гражданской
            ответственности владельца опасного объекта за причинение вреда в
            результате аварии на опасном объекте)
          </li>
          <li>
            ОС № 1216-05 от 07.05.2015г. (обязательное страхование гражданской
            ответственности перевозчика за причинение при перевозках вреда
        ...
        <ul>
          <li>
            <strong>Устав</strong>&nbsp;<a href={file1}>Скачать</a>
          </li>
        </ul>
        <hr />
        ...
        <ul>
          <li>
            ...
            </strong>&nbsp;<a href={file2}>Скачать</a>
          </li>
          <li>
            <strong>Идентификационный номер налогоплательщика</strong>&nbsp;<a
              href={file3}>
              Скачать
            </a>
          </li>
          <li>
            <strong>
              регистрационный номер в едином государственном реестре субъектов
              страхового дела - 1216
            </strong>
          </li>
        </ul>
        <p>
          <span>
            Дата и время последнего изменения на странице: 21.06.2017г., 11:30
          </span>
        </p>
      </div>
    );
