  ...
  render() {
    return (
      <div>
        ...
        <ul>
          <li><strong>Сведения об основном государственном регистрационном номере</strong>&nbsp;<a href={file2}>Скачать</a></li>
          <li><strong>Идентификационный номер налогоплательщика</strong>&nbsp;<a href={file3}>Скачать</a></li>
