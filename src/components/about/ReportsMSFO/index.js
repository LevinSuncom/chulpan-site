  ...
  render() {
    return (
      <div>
        ...
        <ul>
          <li>
            <a href={file1}>Годовая консолидированная отченость по МСФО</a>
          </li>
          <li>
            <a href={file2}>Аудиторское заключение</a>
          </li>
          <li>
            <a href={file3}>
              Примечания к консолидированной бухгалтерской отчетности
            </a>
          </li>
          <li>
            <a href={file4}>Актуарное заключение</a>
          </li>
        </ul>
        <hr />
        За 2015 год
        ...
        <ul>
          <li>
            <a href={file5}>Годовая консолидированная отченость по МСФО</a>
          </li>
          <li>
            <a href={file6}>Аудиторское заключение</a>
          </li>
          <li>
            <a href={file7}>
              Примечания к консолидированной бухгалтерской отчетности
          ...
          <li>
            <a href={file8}>Актуарное заключение</a>
          </li>
        </ul>
        <hr />
        За 2014 год
        ...
        <ul>
          <li>
            <a href={file9}>Годовая консолидированная отченость по МСФО</a>
          </li>
          <li>
            <a href={file10}>Аудиторское заключение</a>
          </li>
          <li>
            <a href={file11}>
              Примечания к консолидированной бухгалтерской отчетности
          ...
          <li>
            <a href={file12}>Актуарное заключение</a>
          </li>
        </ul>
        <hr />
        За 2013 год
        ...
        <ul>
          <li>
            <a href={file13}>Годовая консолидированная отченость по МСФО</a>
          </li>
          <li>
            <a href={file14}>Аудиторское заключение</a>
          </li>
          <li>
            <a href={file15}>
              Примечания к консолидированной бухгалтерской отчетности
        ...
        <ul>
          <li>
            <a href={file17}>Годовая консолидированная отченость по МСФО</a>
          </li>
          <li>
            <a href={file18}>Аудиторское заключение</a>
          </li>
          <li>
            <a href={file19}>
              Примечания к консолидированной бухгалтерской отчетности
        ...
        <p>
          <span>
            Дата и время последнего изменения на странице: 16.05.2017г., 08:30
          </span>
        </p>
      </div>
    );
