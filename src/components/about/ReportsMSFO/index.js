  ...
  render() {
    return (
      <div>
        ...
        <br />
        <ul>
          <li><a href={file1}>Годовая консолидированная отчетность по МСФО</a></li>
        ...
        <br />
        <ul>
          <li><a href={file5}>Годовая консолидированная отчетность по МСФО</a></li>
        ...
        <br />
        <ul>
          <li><a href={file9}>Годовая консолидированная отчетность по МСФО</a></li>
        ...
        <br />
        <ul>
          <li><a href={file13}>Годовая консолидированная отчетность по МСФО</a></li>
        ...
        <br />
        <ul>
          <li><a href={file17}>Годовая консолидированная отчетность по МСФО</a></li>
