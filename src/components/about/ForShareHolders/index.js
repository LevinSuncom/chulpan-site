    ...
    return (
      <div>
        ...
        <ul>
          <li>
            <a href={file1}>
              Отчет об итогах голосования на внеочередном собрании акционеров от
              15.12.2017{' '}
            </a>
          </li>
          <li>
          ...
          <li>
            <a href={file6}>
              ...
              акционеров 14.09.2015г
            </a>
          </li>
          <li>
            <a href={file7}>
              Отчет об итогах голосования на внеочередном общем собрании
              акционеров 11.06.2015г{' '}
            </a>
          </li>
          <li>
            <a href={file8}>
              Отчет об итогах голосования на внеочередном общем собрании
              акционеров 13.10 2014г{' '}
            </a>
          </li>
          <li>
            <a href={file9}>
              Отчет об итогах голосования на внеочередной общем собрании
              акционеров 08.12.2014г{' '}
            </a>
          </li>
          <li>
            <a href={file10}>
        ...
        <ul>
          <li>
            <a href={file11}>
              ...
              "Чулпан" от 23.11.2017г.
            </a>
          </li>
          <li>
            <a href={file12}>
              СООБЩЕНИЕ о проведении годового общего собрания акционеров АО СК
              "Чулпан" от 21.04.2017г.
            </a>
          </li>
          <li>
            <a href={file13}>
              СООБЩЕНИЕ о проведении внеочередного собрания акционеров АО СК
              "Чулпан" от 15.11.2016г.
            </a>
          </li>
          <li>
            <a href={file14}>
              СООБЩЕНИЕ о проведении внеочередного собрания акционеров АО СК
              "Чулпан" от 16.08.2016г.
            </a>
          </li>
          <li>
            <a href={file15}>
              СООБЩЕНИЕ о проведении внеочередного собрания акционеров АО СК
              "Чулпан" от 18.04.2016г.
            </a>
          </li>
          <li>
            <a href={file16}>
              СООБЩЕНИЕ о проведении внеочередного собрания акционеров АО СК
              "Чулпан" от 20.08.2015г.
            </a>
          </li>
          <li>
            <a href={file17}>
              СООБЩЕНИЕ о проведении внеочередного собрания акционеров АО СК
              "Чулпан" от 19.05.2015г.
            </a>
          </li>
          <li>
            <a href={file18}>
              СООБЩЕНИЕ о проведении годового общего собрания акционеров АО СК
              "Чулпан" от 20.04.2015г.
            </a>
          </li>
        </ul>
        <hr />
        <p>
          <span>
            Дата и время последнего изменения на странице: 19.12.2017г., 15:35
          </span>
        </p>
      </div>
    );
