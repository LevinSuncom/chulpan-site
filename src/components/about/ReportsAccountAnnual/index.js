  ...
  render() {
    return (
      <div>
        ...
        <ul>
          <li>
            <a href={file1}>Бухгалтерский баланс (форма 1)</a>
          </li>
          <li>
            <a href={file2}>Отчет о финансовых результатах (форма 2)</a>
          </li>
          <li>
            <a href={file3}>Отчет об изменении капитала (форма 3)</a>
          </li>
          <li>
            <a href={file4}>Отчет о движении денежных средств (форма 4)</a>
          </li>
          <li>
            <a href={file5}>
        ...
        <ul>
          <li>
            <a href={file6}>Бухгалтерский баланс (форма 1)</a>
          </li>
          <li>
            <a href={file7}>Отчет о финансовых результатах (форма 2)</a>
          </li>
          <li>
            <a href={file8}>Отчет об изменении капитала (форма 3)</a>
          </li>
          <li>
            <a href={file9}>Отчет о движении денежных средств (форма 4)</a>
          </li>
          <li>
            <a href={file10}>
              Аудиторское заключение о бухгалтерской отчетности
        ...
        <ul>
          <li>
            <a href={file11}>Бухгалтерский баланс (форма 1)</a>
          </li>
          <li>
            <a href={file12}>Отчет о финансовых результатах (форма 2)</a>
          </li>
          <li>
            <a href={file13}>Отчет об изменении капитала (форма 3)</a>
          </li>
          <li>
            <a href={file14}>Отчет о движении денежных средств (форма 4)</a>
          </li>
          <li>
            <a href={file15}>
              Аудиторское заключение о бухгалтерской отчетности
        ...
        <ul>
          <li>
            <a href={file16}>Бухгалтерский баланс (форма 1)</a>
          </li>
          <li>
            <a href={file17}>Отчет о финансовых результатах (форма 2)</a>
          </li>
          <li>
            <a href={file18}>Отчет об изменении капитала (форма 3)</a>
          </li>
          <li>
            <a href={file19}>Отчет о движении денежных средств (форма 4)</a>
          </li>
          <li>
            <a href={file20}>
              Аудиторское заключение о бухгалтерской отчетности
        ...
        <ul>
          <li>
            <a href={file21}>Бухгалтерский баланс</a>
          </li>
          <li>
            <a href={file22}>
              Аудиторское заключение о бухгалтерской отчетности
        ...
        <ul>
          <li>
            <a href={file23}>Бухгалтерский баланс</a>
          </li>
          <li>
            <a href={file24}>
              Аудиторское заключение о бухгалтерской отчетности
        ...
        <ul>
          <li>
            <a href={file25}>Бухгалтерский баланс</a>
          </li>
          <li>
            <a href={file26}>
              Аудиторское заключение о бухгалтерской отчетности
        ...
        <ul>
          <li>
            <a href={file27}>Бухгалтерский баланс</a>
          </li>
        </ul>
        <hr />
        За 2008 год
        ...
        <ul>
          <li>
            <a href={file28}>Бухгалтерский баланс</a>
          </li>
        </ul>
        <hr />
        <p>
          <span>
            Дата и время последнего изменения на странице: 27.06.2017г., 15:30
          </span>
        </p>
      </div>
    );
