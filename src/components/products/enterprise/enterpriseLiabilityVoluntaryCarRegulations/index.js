...
import statementDraft from '../../../../documents/Бланки договоров/Ответственность/Добровольное/АГО.doc';
...
const EnterpriseRegulations = () => {
  return (
    <div>
      ...
      <h1 className="product-header">Страхование гражданской ответственности автоперевозчиков</h1>
{/*       <p>
