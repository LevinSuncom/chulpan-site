  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>Страхование средств наземного транспорта</li>
        <li>
          <a href="/services/individuals/health/accidents/about">
        ...
        <li>Комбинированное страхование опасных грузов</li>
        <li>Комбинированное страхование средств водного транспорта</li>
        <li>Страхование сельскохозяйственных животных</li>
        <li>
      ...
      <ul>
        ...
        <li>Комбинированное страхование опасных грузов</li>
        <li>Страхование объектов лизинга</li>
        <li>Страхование ответственности продавца за качество продукции</li>
        <li>Страхование непредвиденных расходов</li>
        <li>Страхование гражданской ответственности автоперевозчиков</li>
        <li>Страхование общегражданской ответственности</li>
        <li>Страхование неисполнения договорных обязательств</li>
        <li>Комплексное страхование строительно-монтажных рисков</li>
        <li>Добровольное страхование пассажиров от несчастных случаев</li>
        <li>Страхование пластиковых карт</li>
        <li>
          Страхование потери имущества в результате утраты права собственности
        </li>
        <li>Страхование профессиональной деятельности оценщиков</li>
      </ul>
      <p>
